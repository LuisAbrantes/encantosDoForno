      ...
      <section className="bg-linear-to-r from-orange-800 to-red-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-dancing text-2xl text-amber-100">
            Garanta seu lugar e desfrute de uma experiência inesquecível
          </p>
        </div>
      </section>
          ...
          <div className="bg-white rounded-lg shadow-2xl p-8 md:p-12">
            ...
            <div className="mt-8 p-6 bg-amber-50 rounded-lg">
              ...
              <ul className="space-y-2 text-gray-700">
                <li>
                  • Reservas podem ser canceladas até 2 horas antes do horário
                  agendado.
                </li>
                <li>
                  • Em caso de atraso superior a 15 minutos, a reserva pode ser
                  cancelada.
                </li>
                <li>
                  • Para grupos acima de 7 pessoas, entre em contato direto pelo
                  WhatsApp.
                </li>
                <li>• Confirmação será enviada por email e/ou telefone.</li>
              </ul>
            </div>
          </div>
        </div>
