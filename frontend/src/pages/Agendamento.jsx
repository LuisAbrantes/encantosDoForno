        ...
        <div className="min-h-screen bg-amber-50">
            ...
            <section className="py-8 sm:py-16">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-lg shadow-2xl p-5 sm:p-8 md:p-12">
                        ...
                        <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-amber-50 rounded-lg">
                            <h3 className="font-bold text-orange-900 mb-2 sm:mb-3 flex items-center text-sm sm:text-base">
            ...
            <section className="py-10 sm:py-16 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl sm:text-3xl font-bold text-orange-900 mb-4 sm:mb-6">
                        Prefere falar conosco diretamente?
                    </h2>
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
                        <a
                            href="tel:+5512992611931"
                            className="bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg"
                        >
                            Ligar Agora 📞
                        </a>
                        <a
                            ...
                            className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg"
                        >
                            WhatsApp 💬
                        </a>
                    </div>
