          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="font-sans text-lg text-gray-700 leading-relaxed">
                Localizado no coração de <strong>Jacareí</strong>, o Encantos do
                Forno nasceu do sonho de criar um espaço onde as pessoas
                pudessem se reunir em torno de comida feita com amor e
                dedicação.
              </p>
              <p className="font-sans text-lg text-gray-700 leading-relaxed">
                Nossos pratos são preparados com{" "}
                <strong>ingredientes frescos</strong> e selecionados,
                respeitando receitas tradicionais e trazendo o sabor autêntico
                que aquece o coração.
              </p>
              <p className="font-sans text-lg text-gray-700 leading-relaxed">
                Aqui, tradição e sabor se encontram para proporcionar uma
              ...
              <div className="grid grid-cols-3 gap-4 pt-6">
                <div className="text-center p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="font-bold text-orange-900">Qualidade</div>
                </div>
                <div className="text-center p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-3xl mb-2">🔥</div>
                  <div className="font-bold text-orange-900">Artesanal</div>
                </div>
                <div className="text-center p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-3xl mb-2">❤️</div>
                  <div className="font-bold text-orange-900">Acolhedor</div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="font-sans text-lg text-gray-600 max-w-2xl mx-auto">
              Conheça as pessoas apaixonadas que preparam cada prato com carinho
              e dedicação
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-amber-50 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <div className="p-6">
                ...
                <p className="font-sans text-gray-600">
                  Com paixão pela gastronomia, Julia traz técnicas tradicionais
                  e um toque de inovação para cada receita.
                </p>
              </div>
            </div>
            ...
            <div className="bg-amber-50 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <div className="p-6">
                ...
                <p className="font-sans text-gray-600">
                  Fundador do Encantos do Forno, Marcelo transformou seu amor
                  pela gastronomia em um espaço acolhedor.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="font-sans text-lg text-gray-700 max-w-2xl mx-auto">
              Conheça alguns dos nossos pratos mais amados, preparados com
              ingredientes locais e muito sabor
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-amber-50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="font-allura text-2xl text-gray-700 mb-4 italic text-readable leading-relaxed">
                "A melhor pizza artesanal que já comi em Jacareí! O ambiente é
                super acolhedor e o atendimento impecável. Voltarei com
                certeza!"
              </p>
            ...
            <div className="bg-amber-50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="font-allura text-2xl text-gray-700 mb-4 italic text-readable leading-relaxed">
                "Os pães são incríveis! Você sente que foram feitos com amor.
                Virou tradição da família vir aqui todo domingo."
              </p>
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-bold text-orange-900">Carlos Eduardo</p>
            ...
            <div className="bg-amber-50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="font-allura text-2xl text-gray-700 mb-4 italic text-readable leading-relaxed">
                "Lugar perfeito para um almoço em família. Comida de qualidade,
                ambiente agradável e preços justos. Recomendo muito!"
              </p>
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-bold text-orange-900">Mariana Costa</p>
      ...
      <section className="py-20 bg-linear-to-r from-orange-800 to-red-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-sans text-xl mb-8 text-amber-100 leading-relaxed">
            Faça sua reserva e venha nos visitar! Estamos ansiosos para receber
            você.
          </p>
